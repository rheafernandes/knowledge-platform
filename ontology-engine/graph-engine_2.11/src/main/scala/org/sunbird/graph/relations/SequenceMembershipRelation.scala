...
class SequenceMembershipRelation(graphId: String, startNode: Node, endNode: Node, metadata: Map[String, AnyRef]) extends AbstractRelation(graphId, startNode, endNode, metadata) {
