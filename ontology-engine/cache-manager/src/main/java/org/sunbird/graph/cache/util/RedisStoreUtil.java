...
public class RedisStoreUtil {
	...
	public static void deleteNodeProperties(String graphId, String objectId) {
		...
		try {
			...
			String versionKey = CacheKeyGenerator.getNodePropertyKey(graphId, objectId,"versionKey");
			String consumerId = CacheKeyGenerator.getNodePropertyKey(graphId, objectId,"consumerId");
	...
	public static void saveData(String identifier, Map<String, Object> data, int ttl) {
		try {
			...
			System.out.println("Error while saving data to Redis for Identifier : " + identifier);
			e.printStackTrace();
		}
	}
	...
	public static void delete(String... keys) {
		...
		try {
			...
			System.out.println("Error while deleting data from Redis for Identifiers : " + Arrays.asList(keys));
			e.printStackTrace();
