...
public class Graph extends AbstractDomainObject {
    ...
    public void createUniqueConstraint(Request req) {
        try {
            ...
            Future<Object> response = Future.successful(graphMgr.createUniqueConstraint(request));
    ...
    public void createIndex(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(graphMgr.createIndex(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
    ...
    public void delete(Request req) {
        try {
            Request request = new Request(req);
            Future<Object> response = Future.successful(graphMgr.deleteGraph(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
    ...
    public void addOutRelations(Request request) {
        try {
            Future<Object> response = Future.successful(graphMgr.addOutgoingRelations(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
    ...
    public void addInRelations(Request request) {
        try {
            Future<Object> response = Future.successful(graphMgr.addIncomingRelations(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
            throw new ServerException(GraphEngineErrorCodes.ERR_GRAPH_CREATE_RELATION_NODE_FAILED.name(),
                    e.getMessage(), e);
    ...
    public void searchNodes(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(searchMgr.searchNodes(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
    ...
    public void getDataNodes(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(searchMgr.getNodesByUniqueIds(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
            throw new ServerException(GraphEngineErrorCodes.ERR_GRAPH_SEARCH_NODES_UNKNOWN_ERROR.name(), e.getMessage(),
                    e);
    ...
    public void executeQueryForProps(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(searchMgr.executeQueryForProps(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
    ...
    public void traverse(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(searchMgr.traverse(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
    ...
    public void traverseSubGraph(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(searchMgr.traverseSubGraph(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
            throw new ServerException(GraphEngineErrorCodes.ERR_GRAPH_TRAVERSAL_UNKNOWN_ERROR.name(), e.getMessage(),
                    e);
    ...
    public void getSubGraph(Request req) {
        try {
            Request request = new Request(req);
            request.copyRequestValueObjects(req.getRequest());
            Future<Object> response = Future.successful(searchMgr.getSubGraph(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
            throw new ServerException(GraphEngineErrorCodes.ERR_GRAPH_TRAVERSAL_UNKNOWN_ERROR.name(), e.getMessage(),
                    e);
    ...
    public void bulkUpdateNodes(Request request) {
        try {
            ...
            Future<Object> response = Future.successful(graphMgr.bulkUpdateNodes(request));
            manager.returnResponse(response, getParent());
        } catch (Exception e) {
            throw new ServerException(GraphEngineErrorCodes.ERR_GRAPH_CREATE_RELATION_NODE_FAILED.name(),
                    e.getMessage(), e);
